...
const About = () => {
    ...
    return (
        <div className="w-full py-28 aboutImg" id="about">
            ...
            <div className="m-5 lg:grid lg:grid-cols-2 items-center">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    <div className="flex flex-col items-center ">
                        ...
                        <p className="text-green-500 text-xs font-semibold leading-6">Founder & CEO</p>
                    </div>
                    <div className="flex flex-col items-center ">
                        <img
                            src={Bendy}
            ...
            <a href="#" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full shadow-md outline-0">
                Learn More
            </a>
        </div>
    )
